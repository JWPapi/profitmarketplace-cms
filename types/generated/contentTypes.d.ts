...
export interface ApiIdentityIdentity extends Schema.SingleType {
  ...
  attributes: {
    ...
    updatedAt: Attribute.DateTime
    publishedAt: Attribute.DateTime
    createdBy: Attribute.Relation<'api::identity.identity', 'oneToOne', 'admin::user'> &
      Attribute.Private
    updatedBy: Attribute.Relation<'api::identity.identity', 'oneToOne', 'admin::user'> &
      Attribute.Private
  }
}
